            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {features.map((feature, idx) => (
                        <div key={idx} className="flex flex-col items-center text-center p-8 hover:bg-secondary/20 hover:backdrop-blur-sm rounded-3xl transition-all duration-500 group border border-transparent hover:border-[#C5A059]/10">
                            <div className="mb-6 p-6 bg-[#C5A059]/10 rounded-full group-hover:bg-[#C5A059] group-hover:shadow-[0_0_20px_rgba(197,160,89,0.4)] transition-all duration-500 transform group-hover:scale-110">
                            ...
                            <h3 className="font-serif font-bold text-xl mb-3 text-primary">{feature.title}</h3>
